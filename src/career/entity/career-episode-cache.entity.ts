...
@Entity('career_episode_caches')
@Index('IDX_career_episode_caches_telegram_profile_track', ['telegramId', 'profileHash', 'trackId'], {
    unique: true,
})
export class CareerEpisodeCacheEntity extends BaseEntity {
